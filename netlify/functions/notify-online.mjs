...
return now < new Date(kursTime.getTime() - 15 * 60000);}
          ...
          <div style={S.card}>
            ...
            {changeable && myVote && (
              <div style={{ ...S.cutoffNote, background: "rgba(90,158,110,0.07)" }}>
                ✏️ Du kannst deine Antwort noch bis 15 Min vor Kurs ändern.
              </div>
            )}
            ...
            {myVote && (
              <div style={S.konfirmBox}>
                ...
                <div style={{ fontSize: 13, color: "#5a8a5a", marginTop: 3 }}>Ich freue mich! 🌸</div>
                {myVote === "online" && (
